...
Dequeue.prototype.walk = function(callback) {
    //walks the list and triggers a callback on each node

    var current = this.head.next
    var length = this.length
    var i = 1

    callback(current, length, i)
...
Dequeue.prototype.removeNode = function(index) {
    ...
    if(index === 1) {
        ...
        //Reset the previous next position
        current.next.prev = this.head.next
    ...
    //Removing the last item
        ...
        //Reset the next previous position
